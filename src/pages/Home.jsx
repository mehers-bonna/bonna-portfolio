...
export default function Home() {
  return (
    <section id="home" className="min-h-screen pt-32 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        {/* TEXT SECTION: Slide in from left */}
        <motion.div 
        ...
        >
          <motion.h2 
            ...
            className="text-coral font-bold tracking-[0.3em] uppercase text-xs mb-4"
          >
            Available for Hire
          </motion.h2>
          ...
          <motion.p 
            ...
            className="mt-8 text-slate-400 text-lg max-w-lg leading-relaxed italic"
          >
        ...
        {/* IMAGE SECTION: Floating and Rotating Icons */}
        <div className="relative flex justify-center items-center">
          <div className="relative w-[320px] h-[320px] md:w-[450px] md:h-[450px]">
            ...
            {/* Slow Rotating Skills Icons */}
            <motion.div 
              animate={{ rotate: 360 }} 
              transition={{ duration: 25, repeat: Infinity, ease: "linear" }} 
              className="absolute inset-[-40px] z-20"
            >
